 ...
 *
 */
public class NewFollowPathCommand extends CommandBase {
	private final Follower follower;
	private final PathChain pathChain;
	private final boolean holdEnd;
	private double maxPower = 1.0;

	public NewFollowPathCommand(Follower follower, PathChain pathChain) {
		this(follower, pathChain, true);
	}

	public NewFollowPathCommand(Follower follower, PathChain pathChain, boolean holdEnd) {
		this(follower, pathChain, holdEnd, 1.0);
	}

	public NewFollowPathCommand(Follower follower, PathChain pathChain, double maxPower) {
		this(follower, pathChain, true, maxPower);
	}

	public NewFollowPathCommand(Follower follower, PathChain pathChain, boolean holdEnd, double maxPower) {
	...
	public NewFollowPathCommand(Follower follower, Path path) {
		this(follower, path, true);
	}

	public NewFollowPathCommand(Follower follower, Path path, boolean holdEnd) {
		this(follower, path, holdEnd, 1.0);
	}

	public NewFollowPathCommand(Follower follower, Path path, double maxPower) {
		this(follower, path, true, maxPower);
	}

	public NewFollowPathCommand(Follower follower, Path path, boolean holdEnd, double maxPower) {
		this.follower = follower;
	 ...
	 */
	public NewFollowPathCommand setGlobalMaxPower(double globalMaxPower) {
