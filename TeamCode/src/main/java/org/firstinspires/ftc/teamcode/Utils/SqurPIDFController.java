...
public class SqurPIDFController {
    //**********************************
     ...
     */
    public SqurPIDFController(double p, double i, double d) {
        P = p;
        I = i;
        D = d;
        checkSigns();
     ...
     */
    public SqurPIDFController(double p, double i, double d, double f) {
        P = p;
        I = i;
        D = d;
        F = f;
    ...
    public double getOutput(double actual, double setpoint) {
        ...
        double errorSqr = error * Math.abs(error);
